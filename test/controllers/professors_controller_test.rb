...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference("Professor.count") do
      post professors_url, params: { professor: { email: @professor.email, faculty: @professor.faculty, lastname: @professor.lastname, name: @professor.name, prof_id: @professor.prof_id } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { email: @professor.email, faculty: @professor.faculty, lastname: @professor.lastname, name: @professor.name, prof_id: @professor.prof_id } }
