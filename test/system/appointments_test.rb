...
class AppointmentsTest < ApplicationSystemTestCase
  ...
  test "should create appointment" do
    ...
    fill_in "Faculty", with: @appointment.faculty
    fill_in "Number students", with: @appointment.number_students
    fill_in "Professor", with: @appointment.professor_id
    fill_in "Start time", with: @appointment.start_time
    fill_in "Student", with: @appointment.student_id
    fill_in "Tutor", with: @appointment.tutor_id
